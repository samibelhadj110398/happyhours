...
import static com.reservation.model.Constants.HEADER_STRING;
import static com.reservation.model.Constants.TOKEN_PREFIX;
    ...
    protected void doFilterInternal(HttpServletRequest req, HttpServletResponse res, FilterChain chain) throws IOException, ServletException {
        ...
        if (adminname != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            ...
            if (jwtTokenUtil.validateToken(authToken, userDetails)) {
                ...
                logger.info("authenticated user " + adminname + ", setting security context");
